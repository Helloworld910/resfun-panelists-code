# Metadata ----------------------------------------------------------------
# Title: scrapper-2
# Description: This script scrapes panelists data from the Grant Agency of the Czech Republic website for the year 2022.
...
# Remove any designations
proc_temp <- str_remove(final_df$members[9], "\\(\\w+\\)")
