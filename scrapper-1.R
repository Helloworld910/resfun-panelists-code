# Metadata ----------------------------------------------------------------
# Title: scrapper-1
# Description: This script scrapes panelists data from the Grant Agency of the Czech Republic website for the year 2021 and saves it in the data folder.
...
scrapper_1 <- function() {
  ...
  write.csv(final_df, file = here("data", "data_2021.csv"), 
            row.names = FALSE)
